$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '预览图', name: 'coverUrl', index: 'coverUrl', width: 120, formatter: coverImageFormatter},
            {label: '点赞', name: 'likeNumber', index: 'likeNumber', width: 60},
            {label: '博客分类', name: 'tagName', index: 'tagName', width: 50},
            {label: '添加时间', name: 'articleTime', index: 'articleTime', width: 80}
        ],
        height: 700,
        rowNum: 10,
        rowList: [10, 20, 50],
